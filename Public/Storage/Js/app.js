...
import { PrintUtils } from "./Modules/Utils/PrintUtils.js";
import { TemplateEngine } from "./TemplateEngine.js";
import { ToolboxUtils } from "./Modules/Utils/ToolboxUtils.js";
      ...
      document
        ...
        .addEventListener("submit", function (ev) {
          ev.preventDefault();
            ...
            ///attempt ajax value
            Ajax.http('/register', 'post', 'application/x-www-form-urlencoded', 'application/json', userDatas).then(response => {
